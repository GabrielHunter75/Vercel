...
export default function Home() {
  ...
  return (
    <View style={styles.container}>
      ...
      <FlatList
        data={filteredEventos.slice(0, 6)}
...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: "bold", color: "#c57f39", marginBottom: 10, textAlign: "center" },
  ...
  eventDetails: { fontSize: 14, color: "#c57f39", marginBottom: 5 },
